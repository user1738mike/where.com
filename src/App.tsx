    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route
            path="/vibez/where/login"
            element={
              <ProtectedRoute require="unauthenticated">
                <WhereLogin />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            path="/vibez/where/dashboard"
            element={
              <ProtectedRoute require="completed">
                <WhereDashboard />
              </ProtectedRoute>
            }
          />
